...
{
  return __DAIM_LIB_VERSION__;
}
//---------------------------------------------------------------------------
int dmEnvironment::Revision()
{
  return __DAIM_LIB_REVISION__;
}
//----------------------------------------------------------------------------
dmCString dmEnvironment::VersionStr()
{
   return dmCString::FormatString(dmCString::npos,
		   ...
		   LibraryName().get(),Version(),Revision(),__DAIM_LIB_COMPILED__);
}
//----------------------------------------------------------------------------
dmCString dmEnvironment::LibraryName()
{
#ifdef _DEBUG
  return dmCString(__DAIM_LIB_NAME__ " ( Debug ) ");
#else
  return dmCString(__DAIM_LIB_NAME__ " ( Retail ) ");
#endif
}
//------------------------------------------------------------------
