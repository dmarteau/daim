#ifndef cciScriptableKernelFamily_h
/* :::BEGIN LICENSE BLOCK:::
 *
...
#include "cciIScriptableKernelFamily.h"
...
public:
  ...
  CCI_DECL_ISCRIPTABLEKERNELFAMILY

  cciScriptableKernelFamily();

private:
  ~cciScriptableKernelFamily();

protected:
  long kX,kY,kWidth,kHeight;
...
#endif // cciScriptableKernelFamily_h
